...
remove_line_if_present "${HOME}/.bashrc" 'export PATH="$HOME/.local/bin:$PATH"'
remove_line_if_present "${HOME}/.bashrc" '# extended-grep'
remove_line_if_present "${HOME}/.zshrc" 'export PATH="$HOME/.local/bin:$PATH"'
remove_line_if_present "${HOME}/.zshrc" '# extended-grep'
